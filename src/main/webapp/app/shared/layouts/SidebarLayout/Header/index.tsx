  ...
  return (
    ...
    >
      ...
      <Box display="flex" alignItems="center">
        ...
        {props.isAuthenticated && props.isAdmin && <AdminMenu showOpenAPI={props.isOpenAPIEnabled} showDatabase={!props.isInProduction} />}
        <LocaleMenu currentLocale={props.currentLocale} onClick={handleLocaleChange} />

        <HeaderButtons />
        <HeaderUserbox isAuthenticated={props.isAuthenticated} />
        <Box
          component="span"
          sx={{
            ml: 2,
