...
function HeaderUserbox({ isAuthenticated = false }) {
  const userLoggedIn = useAppSelector(state => state.authentication.account);
  const user = {
    name: userLoggedIn.firstName + ' ' + userLoggedIn.lastName,
    avatar: '/content/images/default-avatar-photo-placeholder.jpg',
    jobtitle: '',
  };
